...
## Project Structure
    ...
    ├── testapiautosetting_123654  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123654`
...
2. Clone this repo and `cd testapiautosetting_123654`
